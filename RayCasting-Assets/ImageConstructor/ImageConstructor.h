...
public:
    ...
    static glm::vec3 calcNormalizeRay(const Light *light, const Intersection intersection, const float factor);

    static bool isHittingAnObject(const Light *light, const Intersection &intersection, float factor,
                                  const glm::vec3 &normlizedRay);
